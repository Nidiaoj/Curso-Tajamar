...
function verSumaPares(aDatos) {
    ...
    let oResult = sumarPares(aDatos)
    for (let i = 0; i < oResult.parciales; i++) {
        const element = oResult.parciales[i];
        console.log(`El parcial es ${ oResult.parciales[i]}`)
        
    }
    
    console.log('El resultado de la suma de los pares es ', oResult.total)
}
